...
class DinoFeaturizer(nn.Module):
    ...
    def __init__(self, dim, cfg):
        ...
        ####amend ###
        self.cluster3 = self.make_clusterer2(12)
        ####amend ###
    ...
    def make_clusterer2(self, in_channels):
        return torch.nn.Sequential(
            torch.nn.Conv2d(in_channels, self.dim,(3, 3),padding = 1))  # ,
    ...
    def forward(self, img, n=1, return_class_feat=False):
        ...
        with torch.no_grad():
            ...
            attentions = attentions.reshape(-1, nh, feat_h, feat_w)
        ...
        if self.proj_type is not None:
            ...
            if self.proj_type == "nonlinear":
                ...
                ######Amend######
                code += self.cluster3(self.dropout(attentions))
                ##############
        else:
            code = image_feat
